...
class NeuralNetwork(object):
    ...
    def actFun(self, z, type):
        ...
        if type == "Tanh" :
            ...
            raise ValueError('Unrecognized activation function type "%s".' % type)
    ...
    def feedforward(self, X, actFun):
        ...
        # calculating y hat(vectors of probabilities = softmax) = d^z_2/sum_j=1^K e^z_2
...
def main():
    ...
    model = NeuralNetwork(nn_input_dim=2, nn_hidden_dim=8 , nn_output_dim=2, actFun_type='Sigmoid')
    model.fit_model(X,y)
